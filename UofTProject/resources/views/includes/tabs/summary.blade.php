        ...
        <div class="row mb-4">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="estimate-undergrate-enrolled" name="estimate-undergrate-enrolled">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    <label for="max-partipate" class="fw-bold">Maximum number of students proposed to participate in IEP:</label>
                    <input type="text" class="form-control" id="max-partipat" name="max-partipat">
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="travel-date" name="travel-date">
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="amount-requeste" name="amount-requeste">
                </div>
            </div>
        </div>
    </fieldset>
